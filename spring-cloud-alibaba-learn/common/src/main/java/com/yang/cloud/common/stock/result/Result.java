...
public class Result<T> {
    ...
    public static Result success() {
        return Result.builder().code(ResultCode.SUCCESS.getCode()).msg(ResultCode.SUCCESS.getMsg()).build();
    }

    public static <E> Result success(E body) {
        return Result.<E>builder().code(ResultCode.SUCCESS.getCode()).msg(ResultCode.SUCCESS.getMsg()).body(body).build();
    }
